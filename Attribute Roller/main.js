...
class Player {
    constructor(characterName = 'Default') {
    ...
    rollAttributes() {
        for (const key in this.attributes){
            ...
            results.sort(function(a,b){return a - b}); //sort converts integers to strings before sorting
...
function shuffleArray(targetArray) { 
    let shuffled = Array.from(targetArray); //array.from creates a copy of the array attached 
...
function sumArrayElements(array){
    ...
    return sum; //can do array.reduce((total, currentNumber) => total + currentNumber);
}